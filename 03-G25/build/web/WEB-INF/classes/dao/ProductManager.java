...
//        st.executeUpdate("INSERT INTO ADMIN1.PRODUCT " + "VALUES (" + PRODUCTID + ", '" + PRODUCTNAME + "', " + STOCK + ", '" + DESCRIPTION + "', " + ARCHIVED + "");
//    }
...
public void updateProduct(int PRODUCTID, String PRODUCTNAME, int STOCK, float PRICE, String DESCRIPTION, int ARCHIVED) throws SQLException {
    st.executeUpdate("UPDATE ADMIN1.PRODUCT SET PRODUCTID")
}
     */
